            ...
            case ID_BTN_CONVERT:
                {
                    ...
                    bool decToHexMode = (SendMessage(GetDlgItem(hwnd, ID_RAD_DEC_HEX), BM_GETCHECK, 0, 0) == BST_CHECKED);
                    ...
                    if (decToHexMode)
                    {
                        ...
                        {
                            resultStr = ConvertDecToHex(inputStr);
                        }
                        else
                        {
                    ...
                    else
                    {
                        ...
                        {
                            resultStr = ConvertHexToDec(inputStr);
                        }
                        else
                        {
                            resultStr = "Bao loi du lieu khong hop le";
